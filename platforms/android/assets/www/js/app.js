...
.controller("LoginCtrl", function($scope, $cordovaOauth, $localStorage, $location) {
    ...
    $scope.login = function() {
        $cordovaOauth.facebook("225045417506532", ["email", "read_stream","user_relationships"]).then(function(result) {
...
.controller("TodayController", function ($scope, $http, $log, VideosService) {

$http.get('http://localhost:3000/generalstream').then(function(resp) {
...
//http://localhost:3000/generalstream
})
...
.controller('VideosController', function ($scope, $http, $log, VideosService, $ionicPopover,$ionicModal) {
    ...
    $scope.saveSearchToPlaylist = function(){
